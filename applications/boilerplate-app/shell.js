let tuval = require("@tuval/core/node");
...
shell.exec(
  `docker cp ${container_name}:/server/portal/static/appstore.json  ../../realm/appstore.json`
);
...
shell.exec(
  `docker cp  ../../realm/appstore.json  ${container_name}:/server/portal/static/appstore.json`
);
shell.echo(`Exposing ${appName}.app to realm container appstore`);
shell.exec(
  `docker cp  ../../realm/applications/${appName}.app  ${container_name}:/server/portal/static/applications/${appName}.app`
);
shell.echo(`All done.`);
